...
namespace Parabox.CSG
{
    ...
    public class DemoCSG : MonoBehaviour
    {
        ...
        public void OnGUI()
        {
            if (GUILayout.Button("Union")) Union();
            if (GUILayout.Button("Subtraction LR")) SubtractionLR();
            if (GUILayout.Button("Subtraction RL")) SubtractionRL();
            if (GUILayout.Button("Intersection")) Intersection();
        }
